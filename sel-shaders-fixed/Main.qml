    ...
    Item {
        ...
        Timer {
            ...
            onTriggered: {
                ...
                if (videoPlayer.position >= 3900) {
                    videoPlayer.pause();
                    frameLockTimer.stop(); // Clear the timer from system memory loop
                }
            }
        }
            ...
            vertexShader: "scanline.vert.qsb"
            fragmentShader: "scanline.frag.qsb"
        ...
        MediaPlayer {
            id: audioPlayer
            source: "Copland_OS.mp3"
            loops: 1

            audioOutput: outChannel
